...
# Cambios: Esdtudiar variables - Modelo con numericas
#-----------------
...
ggsave('./charts/titanic_00_4numvars.png')
...
fwrite(mysubm,'./submission/titanic_00_4numvars_600trees.csv')
