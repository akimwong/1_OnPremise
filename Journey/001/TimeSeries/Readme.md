...
- The submission request numerical values composed only by "restaurant-date" & "number of visitors", to explain in an easy way the time series theory, I will select the information of only 1 restaurant that opens more days per year
